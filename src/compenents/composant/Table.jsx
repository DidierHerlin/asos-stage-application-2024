...
const Table = () => {
  ...
  return (
    <div className="w-full max-w-[1300px] mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:text-gray-200">
    {/* Header */}
        ...
        <>
            ...
            <table className="min-w-full">
              ...
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-700">
                  <th className="px-6 py-3 text-left text-sm font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                    Auteur
                  </th>
                  <th className="px-6 py-3 text-left text-sm font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                    Titre
          ...
          <div className="flex justify-between items-center mt-4">
            <span className="text-sm text-gray-700 dark:text-gray-400">
              Showing {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, rapports.length)} of{" "}
              {rapports.length}
            </span>
            ...
            <div className="flex items-center">
              <Button
                ...
                className={`${
                  currentPage === 1 ? "bg-gray-300 dark:bg-gray-600" : ""
                }`}
              >
                Previous
              </Button>
              ...
              <Button
                ...
                className={`${
                  currentPage === totalPages ? "bg-gray-200 dark:bg-gray-600" : ""
                }`}
              >
                Next
              </Button>
